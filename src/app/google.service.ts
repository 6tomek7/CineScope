...
const authCodeFlowConfig: AuthConfig = {
  ...
  clientId:
    '413745185671-d7d6gfcc07efqst5ft7cfsms41vqs28i.apps.googleusercontent.com',
...
export class GoogleService {
  ...
  userProfileSubject = new BehaviorSubject<UserInfo>({} as UserInfo);
  ...
  signOut() {
    ...
    this.userProfileSubject.next({} as UserInfo);
  }
